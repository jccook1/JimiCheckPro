...
public class VanowV1UpdateActivity extends CommonUpdateActivity {
...
//        super.debugLatestVersion = "1.0.71";

        super.modelName = "vanow V1";
        super.modelNameReg = "^Hi-\\w{0,14}-.2AL3.{2}(\\w{4})";
