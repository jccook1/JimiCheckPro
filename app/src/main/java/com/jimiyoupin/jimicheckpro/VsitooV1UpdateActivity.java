...
public class VsitooV1UpdateActivity extends CommonUpdateActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.isDebug = true;
        super.debugAddresses = new HashSet<>();
        super.debugAddresses.add("A4:C1:DB:43:15:FF");
        super.debugLatestVersion = "1.0.76";

        super.modelName = "VSITOO V1";
        super.modelNameReg = "^Hi-\\w{0,14}-.2ADE.{2}(\\w{4})";
